...
In demo mode, this step uses a small sample of fields per county. That keeps the demonstration fast, but the resulting county totals aren't intended as the realistic estimates that are produced by a production run.
