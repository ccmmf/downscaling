...
Sacramento, Contra Costa) and trains from the first 100 points of the statewide design,
which are space filling on their own. The full chain runs in about ten minutes.
Statewide numbers are at the end.
...
|---|---|---|
| target fields | 22,729 | 385,234 |
| minimum RAM | 16 GB | 400 GB |
| cores used | 4 | 8 |
| download | 1.5 GB | your own ensemble output |
