...
#' downstream clustering in 020_cluster_sites.R.
#'
...
# binary indicator: 1 if crop class present in that year
...
# continuous features that capture cropping-system patterns
